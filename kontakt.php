...
if ($error==false)

		{
			...
			$company_email = "info@actiovita.de";
...
<head>
	...
	<title>Nehmen Sie schnell & unkompliziert mit actioVITA Kontakt auf</title>
		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="/"><img src="images/logo.png" height="87" width="361" alt="actiovita umsorgt zuhause leben 10 jahre"><small><img src="images/logo-small.png" height="87" width="377" alt="actiovita umsorgt zuhause leben 10 jahre"></small></a>
							...
							<ul class="nav navbar-nav" id="nav">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li><a href="actiovita_betreuungskonzept.html">Betreuungskonzept</a></li>
										<li><a href="actiovita_gesetzliche-rahmenbedingungen.html">Gesetzl. Rahmenbedingungen</a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">24-Std.-Betreuung <span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
										<li><a href="betreuung_vorgehen.html">Vorgehen</a></li>
										<li><a href="betreuung_aufgabenbereiche.html">Aufgabenbereiche</a></li>
										<li><a href="betreuung_kosten.html">Kosten</a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">Informationen <span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
										<li><a href="info_pflegebeduerftigkeit-grundpflege.html">Pflegebedürftigkeit</a></li>
...
<li><a href="info_pflegeversicherungen.html">Pflegeversicherungen</a></li>
  ...
  <div class="col-xs-16 col-sm-6 col-md-6">
    <p> <strong>actioVITA GmbH</strong><br>
      Viehweg 15<br>
      35781 Weilburg<br>
  <br>
      Telefon: 06471 - 92740<br>
      Telefax: 06471 - 94072<br>
  <br>
      E-Mail: <a href="mailto:info@actiovita.de">info@actiovita.de</a><br>
      Homepage: <a href="http://www.actiovita.de">www.actiovita.de</a></p>
      <p>&nbsp;</p>
...
<textarea class="form-control" id="comments" name="comments" placeholder="Nachricht an uns..." autocomplete="off"  <?php if($error_comments == "true") 
  ...
  <button type="submit" class="btn btn-default">Formular absenden!</button>
                                                                     ...
                                                                     <nav>
                                                                        <ul class="pager">
                                                                         <li class="previous"><a href="javascript:history.back()"><span aria-hidden="true">&larr;</span> zurück</a></li>
                                                                        </ul>
                                                                    </nav>
                                                                    </article>
                                                                  </div>
						...
						<div class="gray-box-second">
							<a href="#" class="gray-brand"><img src="images/img-05.png" height="47" width="144" alt="actiovita rhein-main"></a>
							<p>actioVITA Rhein-Main: Kunden im gesamten Rhein-Main-Gebiet beraten wir auch in unserer Geschäftsstelle Eschborn und vermitteln dort auch ambulante Pflegekräfte.</p>
							<a href="rhein-main/" class="btn btn-info">Ambulante Pflege</a>
						</div>
	...
	<footer id="footer">
		...
		<div class="f1">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-5">
						<h2>Wichtiges bei actioVITA</h2>
						<div class="open-close">
							<a href="#" class="opener">bitte wählen...</a>
							<ul class="sub-nav slide">
								<li><a href="actiovita_grundsaetzliches.html">über uns</a></li>
								<li><a href="actiovita_betreuungskonzept.html">unser Betreuungskonzept</a></li>
								<li><a href="betreuung_vorgehen.html">24 Stunden Betreuung</a></li>
					...
					<div class="col-sm-4 col-sm-offset-1">
						...
						<p>actioVITA GmbH</p>
						<address>Viehweg 15 <br>35781 Weilburg</address>
						<dl class="contact-info">
							...
							<dd>06471 / 94 07 2</dd>
							<dt> E-Mail:</dt>
							<dd><a href="mailto:&#105;&#110;&#102;&#111;&#064;&#097;&#099;&#116;&#105;&#111;&#118;&#105;&#116;&#097;&#046;&#100;&#101;">&#105;&#110;&#102;&#111;&#064;&#097;&#099;&#116;&#105;&#111;&#118;&#105;&#116;&#097;&#046;&#100;&#101;</a></dd>
						</dl>
					</div>
				</div>
				<div class="sub-info">
					<p>actioVITA ist Mitglied im:</p>
					<div class="sub-logo">
						<img src="images/sub-logo.png" height="58" width="209" alt="vhbp verbaund fur hausliche betreuung und pflege e.v.">
					</div>
					<ul class="social">
						<li><a href="https://www.facebook.com/pages/actioVITA-GMBH/251976334907488" class="icon-social-facebook"></a></li>
										<li><a href="https://twitter.com/actiovita" class="icon-social-twitter"></a></li>
										<li><a href="https://plus.google.com/108996571677360435067/" class="icon-google"></a></li>
					</ul>
				</div>
				<span class="copy">Copyright &copy;2005 - 2015 actioVITA GmbH.  Alle Rechte vorbehalten.</span>
			</div>
		</div>
	</footer>
</div>
